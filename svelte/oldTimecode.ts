...
function onMtcMessage(midiData: any) {
	...
	switch (msgType) {
		...
		case 2:
			...
			break;
		case 3:
			mtcData.seconds = (mtcData.seconds & MTC_QUARTER_FRAME_MASK) | (value << 4);
			break;
		case 4:
			mtcData.minutes = (mtcData.minutes & MTC_FULL_FRAME_MASK) | value;
			break;
		case 5:
			mtcData.minutes = (mtcData.minutes & MTC_QUARTER_FRAME_MASK) | (value << 4);
			break;
		case 6:
			mtcData.hours = (mtcData.hours & MTC_FULL_FRAME_MASK) | value;
			break;
		case 7:
			mtcData.hours = (mtcData.hours & MTC_QUARTER_FRAME_MASK) | ((value & 0x1) << 4);
...
function updateTimecodeDisplay() {
	...
	(document.getElementById('timecode') as HTMLElement).innerText =
