	...
	{#if $drawerStore.id === 'help-general'}
		...
		<div class="space-y-4 p-4">
			...
			<p>
				...
				automatically with Windows to ensure it's always available. You can enable this behaviour by
				right clicking the loopMIDI icon in the systray and selecting <i>Autostart loopMIDI</i>
			</p>

			<h5 class="h5">macOS</h5>
			<p>
			...
			<p>
				Your virtual MIDI port is now set up. Select this IAC Bus as the MIDI output in your DAW and
				as the input in the web app.
			</p>
			...
			<ol class="list-inside list-decimal">
				...
				<li>Load the virtual MIDI module by running: <code>sudo modprobe snd-virmidi</code></li>
				<li>
			...
			<p>
				For a more permanent solution, you can add `snd-virmidi` to your list of modules to load at
				boot:
			</p>
			<ol class="list-inside list-decimal">
				<li>
			...
			<p>
				This combination allows for precise positioning at specific points in the song, while
				maintaining continuous tempo synchronization.
			</p>
			...
			<ol class="list-inside list-decimal">
				...
				<li>The video player will automatically synchronize with your DAW's timeline</li>
			</ol>
		</div>
