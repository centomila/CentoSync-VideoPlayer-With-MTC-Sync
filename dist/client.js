...
function onMtcMessage(midiData) {
...
function getTotalFrames() {
    return (mtcData.hours * 60 * 60 * mtcData.frameRate +
...
function updateTimecodeDisplay() {
    ...
    const audioTrackTimeDisplay = `${audioTrackTime[0]}:${audioTrackTime[1]}:${audioTrackTime[2]}.${padZero(audioTrackTime[3], 3)}`;
    document.getElementById('timecode').innerText = `${hours}:${minutes}:${seconds}  ;  ${frames}`;
    document.getElementById('fps').innerText = fps;
    document.getElementById('totalframes').innerText = totalFrames.toString();
